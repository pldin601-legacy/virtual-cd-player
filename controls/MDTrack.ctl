...
Begin VB.UserControl MDTrack 
   ...
   Begin PicClip.PictureClip DigRes 
      ...
      Rows            =   2
      Cols            =   5
      Picture         =   "MDTrack.ctx":3998
   End
End
Attribute VB_Name = "MDTrack"
...
For Z = 5 To M Step -1
 Dig1(Z - 1).Picture = PClip1.GraphicCell(6)
Next
...
Dig1(2).Picture = DigRes.GraphicCell(Val(Mid$(X, 3, 1)))
Dig1(3).Picture = DigRes.GraphicCell(Val(Mid$(X, 2, 1)))
If Val(Mid$(X, 1, 1)) = "0" Then Dig1(4).Picture = PClip1.GraphicCell(6) Else Dig1(4).Picture = DigRes.GraphicCell(Val(Mid$(X, 1, 1)))
